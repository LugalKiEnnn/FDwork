...
void run_sim_bmn(TString inFile = "ArPb_3.2AGeV_mb_10kev", TString outFile = "$VMCWORKDIR/macro/run/bmnsim.root", Int_t nStartEvent = 0, Int_t nEvents = 10000,
                 enumGenerators generatorName = QGSM, Bool_t useRealEffects = kFALSE)
{
    ...
    primGen->SetBeam(0.5, 0.0, 0.0, 0.0);
